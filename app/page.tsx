...
import { ShoppingBag, Search, User, Heart, Menu, LogOut, ChevronDown } from 'lucide-react';
...
export default function Home() {
  ...
  const handleLogin = (email: string, password: string, name?: string) => {
    // Login is now handled by LoginModal directly via context
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
            ...
            <nav className="hidden md:flex space-x-8">
              <div className="relative" ref={categoriesDropdownRef}>
                <button
                  ...
                  className="text-gray-700 hover:text-pink-500 transition-colors font-light text-sm uppercase tracking-wide flex items-center space-x-1"
                >
                  <span>Categories</span>
                  <ChevronDown className="h-4 w-4" />
                </button>
                {isCategoriesDropdownOpen && (
                  <div className="absolute top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-pink-100 py-2 z-10">
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:text-pink-500 hover:bg-pink-50 transition-colors font-light">Category 1</a>
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:text-pink-500 hover:bg-pink-50 transition-colors font-light">Category 2</a>
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:text-pink-500 hover:bg-pink-50 transition-colors font-light">Category 3</a>
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:text-pink-500 hover:bg-pink-50 transition-colors font-light">Category 4</a>
                  </div>
                )}
              </div>
            </nav>
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={profileDropdownRef}>
                <button
                  ...
                  disabled={isLoading}
                  className="p-2 text-gray-600 hover:text-pink-500 transition-colors flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                  ...
                  {isLoggedIn && !isLoading && (
                    <span className="hidden sm:block text-sm font-light text-gray-300">
                      {user?.email.split('@')[0]}
                    </span>
                  )}
                </button>
                {isLoggedIn && !isLoading && isProfileDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-pink-100 py-2 z-10">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-sm text-gray-700 hover:text-pink-500 hover:bg-pink-50 transition-colors flex items-center space-x-2 font-light disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <User className="h-4 w-4" />
      ...
      <section className="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
        ...
        >
          {/* Slide 1 */}
          <SwiperSlide>
            <div className="relative w-full h-full bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center">
              <img
              ...
              <div className="relative z-10 text-center text-white bg-black/50 p-8 rounded-lg max-w-2xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-light mb-6">
                  {isLoggedIn ? `Welcome back, ${user?.name || user?.email.split('@')[0]}!` : 'Elegant Collection'}
                </h2>
          ...
          {/* Slide 2 */}
          <SwiperSlide>
            <div className="relative w-full h-full bg-gradient-to-r from-purple-100 via-indigo-100 to-pink-100 flex items-center justify-center">
              <img
          ...
          {/* Slide 3 */}
          <SwiperSlide>
            <div className="relative w-full h-full bg-gradient-to-r from-blue-100 via-cyan-100 to-purple-100 flex items-center justify-center">
              <img
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <Link href="/hijab" className="group">
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-pink-100 group-hover:border-pink-300">
              ...
              <div className="p-6 text-center">
                <h4 className="text-lg font-light text-gray-800 mb-2 group-hover:text-pink-500 transition-colors">
                  Hijab Collection
                </h4>
          ...
          <Link href="/upper-body" className="group">
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-purple-100 group-hover:border-purple-300">
              <div className="relative h-64 bg-gradient-to-br from-purple-100 to-indigo-100 flex items-center justify-center">
                <div className="text-6xl">👗</div>
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-300"></div>
              </div>
              <div className="p-6 text-center">
                <h4 className="text-lg font-light text-gray-800 mb-2 group-hover:text-purple-500 transition-colors">
                  Blouses & Tops
                </h4>
                <p className="text-sm text-gray-600 font-light">
                  Stylish tops and blouses for every occasion
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/lower-body" className="group">
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-blue-100 group-hover:border-blue-300">
              <div className="relative h-64 bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
                <div className="text-6xl">👖</div>
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-300"></div>
              </div>
              <div className="p-6 text-center">
                <h4 className="text-lg font-light text-gray-800 mb-2 group-hover:text-blue-500 transition-colors">
                  Skirts & Pants
                </h4>
                <p className="text-sm text-gray-600 font-light">
                  Elegant skirts and comfortable pants
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/accessories" className="group">
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-green-100 group-hover:border-green-300">
              <div className="relative h-64 bg-gradient-to-br from-green-100 to-teal-100 flex items-center justify-center">
                <div className="text-6xl">👜</div>
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors duration-300"></div>
              </div>
              <div className="p-6 text-center">
                <h4 className="text-lg font-light text-gray-800 mb-2 group-hover:text-green-500 transition-colors">
                  Fashion Accessories
                </h4>
                <p className="text-sm text-gray-600 font-light">
